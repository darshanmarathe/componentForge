...
export class Component extends HTMLElement {
  ...
  constructor(shadow = true, _props = {}) {
    ...
    (_a = this.root.querySelectorAll("slot")) === null || _a === void 0
      ? void 0
      : _a.forEach((slot) => {
  ...
  async BuildProps() {
    ...
    for (const key of keys) {
      if (key.toLowerCase().startsWith("data-")) {
        ...
        props[key.replace("data-", "")] =
          typeof this.getAttribute(key) === "object"
        ...
        Object.defineProperty(this, attribute, {
          ...
          set(attrValue) {
            ...
            if (attrValue !== undefined) {
              ...
              if (oldValue !== attrValue) this.PreRender();
            } else {
              this.removeAttribute(attribute);
            }
            this.ComponentDidReceiedProps &&
